    ...
    var RESTLET = {
        execute: function (context) {
            ...
            try {
                ...
                util.extend(Current, {
                    poId: 2217661, //context.PO_LINK,
                    billFileId: 236201, //context.ID,
                    billInAdvance: false, //context.billInAdvance || false,
                    processVariance: true, //context.PROC_VARIANCE || false,
                    poVendor: 1635, //context.entity,
                    invoiceNo: 66521842 //context.invoiceNo
                });
                ...
                var BILLPROC = vc_billprocess.preprocessBill({
