 ...
 */
define(['N/ui/serverWidget', 'N/record', 'N/log', 'N/redirect', 'N/search'], function (
    serverWidget,
    record,
    log,
    redirect,
    ...
    function onRequest(context) {
        ...
        function buildForm(rec) {
            ...
            if (
                ...
                // add actions if pending or error or closed or hold
                    ...
                    switch (currentStatus) {
                        case '5': //closed
                            ...
                            if (
                                ...
                                poStatus == 'Pending Billing/Partially Received' ||
                                poStatus == 'Pending Billing'
                            ) {
                                action.addSelectOption({
                                    value: 'manual',
            ...
            processVariance.defaultValue =
                BOOLMAP[rec.getValue('custrecord_ctc_vc_bill_proc_variance')];
