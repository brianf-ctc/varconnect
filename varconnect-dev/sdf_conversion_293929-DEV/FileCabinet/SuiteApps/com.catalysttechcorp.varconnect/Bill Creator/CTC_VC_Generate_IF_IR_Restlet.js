 ...
 *@NScriptType Restlet
 */
define(['N/record', 'N/search', 'N/log', 'N/format', './Libraries/lodash'],
    function(record, search, log, format, lodash) {
        ...
        function _post(context) {
            ...
            if (poEntity == '75' || poEntity == '203' || poEntity == '216' || poEntity == '371' || poEntity == '496') {
                ...
                var transactionSearchObj = search.create({
                    ...
                    filters: [
                        ["mainline", "is", "T"],
                        "AND", ["externalid", "is", 'ifir_' + billPayload.invoice],
                ...
                if (myStatus == 'Pending Billing/Partially Received' || myStatus == 'Pending Receipt' || myStatus == 'Partially Received') {
                    process = true;
                };
