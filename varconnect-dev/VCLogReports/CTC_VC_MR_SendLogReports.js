...
define((require) => {
    ...
    const CRED = {
        ...
        SCRIPT_ID: '190',
        DEPLOYMENT_ID: '1',
        SCRIPT_URL: 'https://tstdrv2486528.restlets.api.netsuite.com/app/site/hosting/restlet.nl'
    };
    ...
    const sendEmail = (emailMsg) => {
        ns_email.send({
            ...
            subject: (() => {
                ...
                return `Send Log Reports - ${ci.getValue('companyname')} | ${ci.getValue(
                    'companyid'
                )}`;
            })(),
            body: emailMsg
