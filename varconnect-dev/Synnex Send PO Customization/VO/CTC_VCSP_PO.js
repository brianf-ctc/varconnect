...
define(['N/search', '../Library/CTC_VCSP_Constants.js'], function (search, constants) {
    ...
    function PurchaseOrder(recPO) {
        ...
        this.synnexShippingCode = shipMethodCode;
        this.dellShippingCode = _getFieldValue({
            recPO: recPO,
            field: constants.Fields.Transaction.DELL_SHIP_CODE
        }) || shipMethodCode;
        ...
        for (var i = 0; i < itemCount; i++) {
            this.items.push({
                ...
                quotenumber: _getSublistText({
                    recPO: recPO,
                    sublist: 'item',
                    field: constants.Fields.Transaction.Item.QUOTE_NUMBER,
                    line: i
                }),
                manufacturer: _getSublistValue({
                    recPO: recPO,
                    sublist: 'item',
                    field: constants.Fields.Transaction.Item.MANUFACTURER,
                    line: i
                }),
                ...
                dellSKU: _getSublistValue({
                    recPO: recPO,
                    sublist: 'item',
                    field: constants.Fields.Transaction.Item.DELL_SKU,
                    line: i
                })
            });
        }
