    ...
    var Helper = {
        ...
        getAltPartNumValues: function (option) {
            ...
            if (option.vendorConfig) {
                skuColumn = option.vendorConfig.itemColumnIdToMatch;
                mpnColumn = option.vendorConfig.itemMPNColumnIdToMatch;
                isItemOnlyMatchedWithVendorSKU = option.vendorConfig.matchItemToPartNumber;
                isMPNMatchedWithName = option.vendorConfig.matchMPNWithPartNumber;
            }
        ...
        try {
            ...
            for (var i = 0; i < myArr.length; i++) {
                ...
                if (!poData) {
                    ...
                    var ordStatVendorCfg = Helper.loadOrderStatusVendorConfig({
                        vendor: poData.entityId,
                        vendorName: poData.entityName,
