        ...
        preprocessVarianceLines: function (option) {
            ...
            for (var varTypeName in VARIANCE_TYPE) {
                ...
                if (!vc2_util.isEmpty(matchingVarianceLine)) {
                    matchingVarianceLine.rate = vc2_util.forceFloat(
                        matchingVarianceLine.rate
                    );
                    matchingVarianceLine.amount = vc2_util.forceFloat(
                        matchingVarianceLine.amount
                    );
                }
                    ...
                    case VARIANCE_TYPE.SHIP:
                        ...
                        if (shipVariance.amount > 0) {
                            ...
                            if (shipVariance.enabled) {
                                Current.varianceParam.listVariance.push(
                                    'Shipping'
                                );
                            }
                        }
