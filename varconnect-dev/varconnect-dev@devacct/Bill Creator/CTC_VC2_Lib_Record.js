    ...
    util.extend(VC_RecordLib, {
        matchOrderLines: function (option) {
            ...
            try {
                ...
                vc2_util.log(logTitle, '>> orderLines: ', arrOrderLines);
                ...
                arrVendorLines.forEach(function (vendorLine) {
                    ...
                    // vc2_util.log(logTitle, '... matched? > : ', {
                    //     vendorLine: vendorLine,
                    //     fullyMatched: matchingOrderLines.fullyMatched.length,
                    //     itemRate: matchingOrderLines.itemRate.length,
                    //     itemQty: matchingOrderLines.itemQty.length,
                    //     itemOnly: matchingOrderLines.itemOnly.length
                    // });
