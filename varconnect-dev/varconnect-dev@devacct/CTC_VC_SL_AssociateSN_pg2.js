...
define([
    ...
    function doGet(context) {
        ...
        form.addField({
            ...
            label:
                'The following items and serial numbers are available to link to this transaction.</br>Select the serial numbers to associate and click Save Serial Numbers button</br></br>' +
                labelTransType +
                ':&nbsp&nbsp' +
                scriptOrderNum +
                '&nbsp&nbsp&nbsp&nbsp&nbspCreated From:&nbsp&nbsp' +
                parentName
        });
    ...
    function doPost(context) {
        ...
        for (var i = 0; i < lineCount; i++) {
            ...
            if (included == 'T') {
                ...
                log.debug({
                    title: 'In POST code',
                    details: 'SN ID ' + includedItem + ' is included'
                });
