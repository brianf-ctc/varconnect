    ...
    var VC_RecordLib = {
        ...
        extractVendorItemNames: function(option) {
            ...
            try {
                ...
                if (returnValue && returnValue.length) {
                    ...
                    log.debug(logTitle, 'Lookup items for assigned vendor names... ' + uniqueItemIds.join(', '));
                    if (uniqueItemIds.length) {
                        var searchOption = {
                            ...
                            columns: [
                                ItemMapRecordVar.FIELD.NAME,
                                ItemMapRecordVar.FIELD.ITEM,
                            ]
                        };
        ...
        isVendorLineMatched: function (option) {
            ...
            var item = {
                ...
                altText:
                    option.itemAltText ||
                    orderLine[GlobalVar.ITEM_FUL_ID_LOOKUP_COL + '_text'],
            ...
            try {
                ...
                } else if (item.vendorItemNames && vc2_util.inArray(vendorLine.item_num, item.vendorItemNames.split('\n'))) {
                    matchedValue = 'VendorSKU';
                }
