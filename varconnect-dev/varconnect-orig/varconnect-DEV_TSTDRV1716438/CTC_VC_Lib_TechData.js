            ...
            if (itemInfoNodes != null) {
                ...
                for (var j = 0; j < itemInfoNodes.length; j++) {
                    ...
                    var orderNum = util.getNodeTextContent(
                        xml.XPath.select({ node: orderInfoNode, xpath: 'InvoiceNbr' })[0]
                    );
                    ...
                    var orderDate = util.getNodeTextContent(
                        xml.XPath.select({ node: orderInfoNode, xpath: 'OrderDate' })[0]
                    );
                    ...
                    var eta = util.getNodeTextContent(
                        xml.XPath.select({ node: orderInfoNode, xpath: 'EstShipDate' })[0]
                    );
                    ...
                    var containerID = util.getNodeTextContent(
                        xml.XPath.select({ node: containerInfoNode, xpath: 'ContainerID' })[0]
                    );
                    ...
                    var dateShipped = util.getNodeTextContent(
                        xml.XPath.select({ node: containerInfoNode, xpath: 'DateShipped' })[0]
                    );
                    ...
                    var warehouse = util.getNodeTextContent(
                        xml.XPath.select({ node: containerInfoNode, xpath: 'WhseDesc' })[0]
                    );
                    ...
                    var carrier = util.getNodeTextContent(
                        xml.XPath.select({ node: containerInfoNode, xpath: 'ShipViaDesc' })[0]
                    );
                    ...
                    var shipQty = util.getNodeTextContent(
                        xml.XPath.select({ node: itemInfoNodes[j], xpath: 'QtyShipped' })[0]
                    );
                    ...
                    var serialNumberInfo = util.getNodeTextContent(
                        xml.XPath.select({ node: itemInfoNodes[j], xpath: 'SerialNbrInd' })[0]
                    );
