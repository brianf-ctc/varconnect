...
define(function (require) {
    ...
    EntryPoint.saveRecord = function (context) {
        try {
            ...
            var xmlVendorField =
                objRec.type == 'customrecord_ctc_vc_vendor_config'
                    ? 'custrecord_ctc_vc_xml_vendor'
                    : 'custrecord_vc_bc_xmlapi_vendor';
            ...
            var objFields =
                objRec.type == 'customrecord_ctc_vc_vendor_config'
                    ? VC_CONFIG_FIELDS.ORDER_STATUS[xmlVendor]
                    : VC_CONFIG_FIELDS.BILL_CREATE[xmlVendor];
    ...
    function displayError(option) {
        if (!Helper.isEmpty(objMsg)) {
            setTimeout(objMsg.hide, 10);
        }
