...
define([
    ...
    function updateItemReceipts(options) {
        ...
        try {
            ...
            for (var i = 0; i < lineData.length; i++) {
                if (receiptOrders.indexOf(lineData[i].order_num) < 0) receiptOrders.push(lineData[i].order_num);
            }
            ...
            for (var j = 0; j < receiptOrders.length; j++) {
                ...
                for (var x = 0; x < lineData.length; x++) {
                    ...
                    if (lineData[x].hasOwnProperty('is_shipped') && lineData[x].is_shipped === false) {
                ...
                for (var tmp3 = 0; tmp3 < uniqueItems.length; tmp3++) {
                    ...
                    if (vc2_constant.GLOBAL.VENDOR_SKU_LOOKUP_COL && uniqueItems[tmp3].vendorSKU != 'NA') {
