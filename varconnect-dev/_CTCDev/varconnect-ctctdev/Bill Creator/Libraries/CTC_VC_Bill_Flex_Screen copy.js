...
define([
    ...
    var FlexScreen_UI = {
        initialize: function (scriptContext) {
            ...
            if (Current.PO_ID) {
                ...
                if (vc2_constant.GLOBAL.ENABLE_SUBSIDIARIES) poColumns.push('subsidiary');
        ...
        viewForm: function (scriptContext) {
            ...
            arrBillLines.forEach(function (billLine, i) {
                ...
                if (Current.IS_ACTIVE_EDIT) {
                    ...
                    if (!vc2_util.isEmpty(billLine.Errors))
                        lineErrors = lineErrors.concat(billLine.Errors);

                    if (!vc2_util.isEmpty(billLine.Variance))
                        lineErrors = lineErrors.concat(billLine.Variance);
    ...
    var Helper = {
        ...
        isBillable: function () {
            ...
            try {
                if (!Current.PO_DATA) throw 'MISSING: PO Data';
                ...
                if (vc2_util.inArray(Current.PO_DATA.statusRef, ['fullyBilled', 'closed'])) {
