...
function(record,
	...
	function _validateLicense(options) {
		...
		if (response == 'invalid') {
			log.warn('License expired', 'License is no longer valid or have expired. Please contact damon@nscatalyst.com to get a new license. Your product has been disabled.');
			result = false;
		}
