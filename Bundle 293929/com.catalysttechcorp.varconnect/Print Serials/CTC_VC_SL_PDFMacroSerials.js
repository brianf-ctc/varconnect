...
define(['N/search', 'N/runtime', 'N/record'],
    function (NS_Search, NS_Runtime, NS_Record) {
        ...
        var VC_Helper = {
            searchSerials: function (option) {
                ...
                var filters = [{
        				name: recType == NS_Record.Type.INVOICE ?
                                'custrecordserialinvoice' : 'custrecorditemfulfillment',
        				operator: 'anyof',
        				values: recId
        			}],
        			columns = [{name: 'name'},
        ...
        var EndPoint = {
            onRequest: function (context) {
                ...
                var requestData = {
                    ...
                    macroKeyParam: NS_Runtime.getCurrentScript().getParameter({ name: 'custscript_ctc_vc_pdfmacro_name' }),
                };
                ...
                try {
                    ...
                    if ( Helper.isEmpty(requestData.mkey) ||
                ...
                var macroFld, macroValue, macroValues = [];
