...
var VCFolder = "/SuiteScripts/CTC.SS2/VCFolder";
require([
    "N/search",
    "N/record",
    "N/runtime",
    ...
    function getInputData() {
        ...
        var filters = [
            ...
            ["custrecord_ctc_vc_bill_proc_status", "anyof", 
                BILL_FILE_STATUS.PENDING, BILL_FILE_STATUS.REPROCESS], "AND",
        ...
        if (billInAdvance == true) {
            ...
            filters.push("AND");
            filters.push([
                "custrecord_ctc_vc_bill_linked_po.status", "anyof",
    ...
    function reduce(context) {
        ...
        try {
            ...
            log.debug(logTitle, '>> responseBody: ' + JSON.stringify(createBillResponse.body) );
