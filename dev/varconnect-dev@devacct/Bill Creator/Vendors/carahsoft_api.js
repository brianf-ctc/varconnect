...
define(function (require) {
	...
	function getOrderDetails(config){
		...
		var orderListUrl = config.url+"/Order/?$filter=CustomerPO eq '"+config.poNum+"'&$expand=Details($expand=LineItems)";
	...
	function getItemArray(arrData,arrInvoiceData,objOrder){
        ...
        if(vc2_util.isEmpty(arrItem) || arrItem.length<=0){return;}
