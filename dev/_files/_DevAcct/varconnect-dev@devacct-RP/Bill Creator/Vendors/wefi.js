...
define(['N/error', 'N/search', 'N/crypto', '../../CTC_VC2_Lib_Utils'], function (
    ...
    WEFI_BC.generateChecksum = function () {
        var vendorConfig = this.vendorConfig,
            checkSum = '';
        if (vendorConfig) {
            ...
            hash.update({
                input: JSON.stringify({
                    id: vendorConfig.id,
                    subsidiary: vendorConfig.subsidiary,
                    country: vendorConfig.country,
                    ack_function: vendorConfig.ack_function,
                    entry_function: vendorConfig.entry_function,
                    user_id: vendorConfig.user_id,
                    user_pass: vendorConfig.user_pass,
                    partner_id: vendorConfig.partner_id,
                    host_key: vendorConfig.host_key,
                    url: vendorConfig.url,
                    res_path: vendorConfig.res_path,
                    ack_path: vendorConfig.ack_path,
                    token_url: vendorConfig.token_url,
                    scope: vendorConfig.scope,
                    subscription_key: vendorConfig.subscription_key
                })
            });
